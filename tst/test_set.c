...
static void test_invalid_init(void)
{
    ...
    assert(!set_init(max_size, compare_int));
}
...
static void ordered_retrieval_global_peak(void)
{
    int *get;
    int val = 4;
    set me = set_init(sizeof(int), compare_int);
...
static void ordered_retrieval_local_peak(void)
{
